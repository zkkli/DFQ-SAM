...
def parse_args():
    ...
    parser.add_argument("--work_dir", type=str, default="/home/zhangjing/SAM-Med2D", help="work dir")
    parser.add_argument("--run_name", type=str, default="sammed", help="run model name")
    parser.add_argument("--batch_size", type=int, default=1, help="batch size")
    parser.add_argument("--image_size", type=int, default=256, help="image_size")
    parser.add_argument('--device', type=str, default='cuda')
    parser.add_argument("--data_path", type=str, default="/home/zhangjing/MedSAM/data/FLARE22Train_png2", help="train data path") 
...
def main(args):
    ...
    for i, batched_input in enumerate(test_pbar):
        ...
        if args.save_pred:
            save_masks2(ori_images, ori_labels, masks, save_path, img_name, args.image_size, original_size, pad, batched_input.get("boxes", None), points_show)
