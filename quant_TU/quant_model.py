...
from quant_utils.build_model import MatMul
# from mmdet.models.backbones.swin_transformer import MatMul

from .quant_modules import QuantConv2d, QuantLinear, QuantMatMul, QuantStdConv2d
...
def quant_image_encoder(args, model, input_quant_params={}, weight_quant_params={}):
    ...
    input_quant_params_channel['channel_wise'] = True    # True
